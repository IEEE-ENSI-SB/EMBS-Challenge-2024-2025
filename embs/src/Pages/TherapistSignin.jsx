    ...
    <div>
      ...
      <div className="background1">
        <form className="form2" onSubmit={handleSubmit}>
          ...
          <label htmlFor="address" className="label1">Therapist ID</label>
          <div className="input-box">
            <input 
              type="text" 
              placeholder="Write your ID provided from our team" 
              value={address}
              onChange={(e) => setAddress(e.target.value)}
            />
          </div>
          ...
          <button type="submit" className="button2">Create an account</button>
